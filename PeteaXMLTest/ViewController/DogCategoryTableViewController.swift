...
class DogCategoryTableViewController: UITableViewController,TagListViewDelegate,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate
{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        {
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: "dogLabelCell", for: indexPath)
            return cell
    ...
    func request()
    {
        ...
        let requestUrl = "https://petea.jp/category/dog/json"
